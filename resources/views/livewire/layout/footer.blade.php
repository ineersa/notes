<div class="flex flex-col items-center bg-gray-100 dark:bg-gray-900">
    <div class="mb-3 flex space-x-4">
        ...
        <a class="text-sm text-gray-500 transition hover:text-gray-600" target="_blank" rel="noopener noreferrer" href="https://github.com/ineersa">
        ...
        <a class="text-sm text-gray-500 transition hover:text-gray-600" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/illia-vasylevskyi-b7353558/">
    ...
    <div class="mb-2 flex space-x-2 text-sm text-gray-500 dark:text-gray-400">
        <div>Illia Vasylevskyi</div>
        <div>• </div>
        <div>© {{ \Carbon\Carbon::now()->format('Y') }}</div>
        <div>• </div>
